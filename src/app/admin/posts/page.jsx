                  ...
                  <table className="text-left rounded-md mt-3 table-fixed w-full">
                    <thead>
                      <tr className="bg-blue-300 text-center" >
                        <th className="p-2 border-[1px]">Post ID</th>
                        <th className="p-2 border-[1px]">Post Title</th>
                        <th className="p-2 border-[1px]">Post Image</th>
                        <th className="p-2 border-[1px]">Post Content</th>
                    ...
                    <tbody>
                        <tr className="text-center">
                            ...
                            <td className="p-2">This is post title</td>
                            <td className="p-2">
                                <Image
                            ...
                            <td className="p-2">This is  Post Content</td>
                            <td className="p-2">
